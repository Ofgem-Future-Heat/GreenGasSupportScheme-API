...
namespace Ofgem.API.GGSS.Persistence.Migrations.ApplicationDb
{
    ...
    [Migration("20210913160207_AddIsResponsiblePersonColumnToUser")]
    partial class AddIsResponsiblePersonColumnToUser
    {
            ...
            modelBuilder.Entity("Ofgem.API.GGSS.Application.Entities.Organisation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Json = "{\"RegisteredOfficeAddress\":{\"Postcode\":\"E14 4PU\",\"County\":null,\"Town\":\"London\",\"LineTwo\":\"Canary Wharf\",\"LineOne\":\"10 South Colonade\",\"Name\":null},\"LegalDocument\":null,\"Type\":\"Private\",\"Error\":null,\"ReferenceNumber\":\"67d3e29f-565b-41f3-b1fa-38bee6f1dfa5\",\"RegistrationNumber\":\"1234567\",\"Name\":\"Clydebiomass UK\"}"
                        });
                });
